...
/**
 * Tests my ACE,7 vs dealer 6 which should be DOUBLE_DOWN.
 */
public class Test00_A7_6 {
    @Test
    public void test() {
        ...
        System.out.println("Boundary Condition (Hand vs Up Card = advice): (ACE + 7) vs 2 = DOUBLE_DOWN");
