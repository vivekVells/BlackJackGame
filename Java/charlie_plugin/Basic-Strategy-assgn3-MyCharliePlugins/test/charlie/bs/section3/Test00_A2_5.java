...
/**
 * Tests my ACE,2 vs dealer 5 which should be DOUBLE_DOWN.
 */
public class Test00_A2_5 {
    @Test
    public void test() {
        ...
        System.out.println("Boundary Condition (Hand vs Up Card = advice): (ACE + 2) vs 5 = DOUBLE_DOWN");
