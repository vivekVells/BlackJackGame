...
/**
 * This class helps to make the DeweyAutoBot that uses Basic Strategy during its turn
 * @author Vivek Vellaiyappan Surulimuthu | vivekvellaiyappans@gmail.com
 */
public class DeweyAutoBot implements IBot, Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(DeweyAutoBot.class.getName()).log(Level.SEVERE, null, ex);
        }
