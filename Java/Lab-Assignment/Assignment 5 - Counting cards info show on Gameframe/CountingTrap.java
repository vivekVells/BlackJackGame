 ...
 */
public class HiLoCounter implements ITrap {
    ...
    public void onSend(Message msg) {
        LOG.info("onSend overriding function from HiLoCounter.java file");
    }

    @Override
    public void onReceive(Message msg) {        
        LOG.info("onReceive overriding function from HiLoCounter.java file");
